        ...
        <div class="container-fluid flex-grow-1 container-p-y">
            ...
            <div class="row">
                ...
                <div class="card col-lg-12 mb-4">
                    <h6 class="card-header">Formulir Pembuatan Hak Akses</h6>

                    <div class="card-body">

                        <form action="{{ route('hak_akses.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_permission" class="form-control"
                                    placeholder="Contoh: tambah_barang" value="{{ old('nama_permission') }}" required>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="feather icon-save"></i> Simpan Hak Akses
                                </button>
