        ...
        <div class="container-fluid flex-grow-1 container-p-y">
            ...
            <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Hitung Stok</li>
                </ol>
            </div>
            <div class="row">
                <!-- 1st row Start -->
                            ...
                            <div class="card mb-4">
                                <div style="border: none !important"
                                    ...
                                    <h6 class="card-header-title mb-0">
                                        <i class="feather icon-truck mr-2"></i> Riwayat Hitung Stok Oleh {{ Auth::guard('pengguna')->user()->nama }}
                                    </h6>
                                    ...
                                    <div class="d-flex gap-5">
                                        ...
                                        <div class="d-flex mr-5 align-items-center">
                                            ...
                                            <input type="text" class="form-control form-control-sm mr-2" id="searchTable"
                                                placeholder="Search data riwayat hitung stok..." style="width:150px">

                                        </div>
                                        
                                        @if(hasPermission('tambah', 'hitung_stok'))
                                        <a href="{{ route('hitung-stok.create') }}" class="btn btn-primary btn-sm">
                                            <i class="feather icon-plus"></i> Buat Laporan Hitung Stok
                                        </a>
                                        @endif
                                                ...
                                                <table class="table table-modern table-hover" id="table">
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            @if (Auth::guard('pengguna')->user()->role->nama_role === 'super_admin' || Auth::guard('pengguna')->user()->role->nama_role === 'admin')
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($adjustments as $index => $adj)
                                                            <tr class="main-row" data-id="{{ $adj->id }}">
                                                                ...
                                                                <td>
                                                                    @if ($adj->status === 'approve')
                                                                        <span class="badge badge-success">Approved</span>
                                                                    @elseif ($adj->status === 'pending')
                                                                        <span class="badge badge-warning">Pending</span>
                                                                    @elseif ($adj->status === 'failed')
                                                                ...
                                                                <td>
                                                                    @if ($adj->status !== 'approve')
                                                                    <a href="{{ route('hitung-stok.edit', $adj->id) }}"
                                                                        class="btn btn-sm btn-blue" style="background: #00499b;color:white">
                                                                    ...
                                                                    {{-- <form
                                                                        action="{{ route('hitung-stok.destroy', $adj->id) }}"
