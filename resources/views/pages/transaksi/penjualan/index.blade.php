                                ...
                                <div style="border:none !important"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <h6 class="card-header-title mb-0">
                                            ...
                                            <span id="lastRefreshed" class="text-muted small ml-1 d-none d-md-inline"></span>
                                        </h6>
                                    ...
                                    <div class="tab-content" style="width:100%">
                                        <div class="tab-pane fade show active pb-4 px-2 px-md-4" id="sale-stats">
                                            <div style="overflow-x:auto;-webkit-overflow-scrolling:touch">
                                                <table class="table table-modern table-hover" id="table" style="min-width:700px">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="sortable" data-column="2">Kode Penjualan <i class="feather icon-chevrons-up sort-icon"></i></th>
                                                            <th class="sortable" data-column="3">Nomor Resi <i class="feather icon-chevrons-up sort-icon"></i></th>
                                                            <th class="sortable d-none d-lg-table-cell" data-column="4">No. Pesanan <i class="feather icon-chevrons-up sort-icon"></i></th>
                                                            <th class="sortable d-none d-xl-table-cell" data-column="5">No. Transaksi <i class="feather icon-chevrons-up sort-icon"></i></th>
                                                            <th class="sortable d-none d-md-table-cell" data-column="6">Dropshipper <i class="feather icon-chevrons-up sort-icon"></i></th>
                                                            <th class="sortable" data-column="7">Tanggal <i class="feather icon-chevrons-up sort-icon"></i></th>
                                                            <th class="sortable d-none d-md-table-cell" data-column="8">Total Harga <i class="feather icon-chevrons-up sort-icon"></i></th>
                                                            <th class="sortable" data-column="9">Scan Out <i class="feather icon-chevrons-up sort-icon"></i></th>
                                                            <th class="sortable d-none d-sm-table-cell" data-column="10">Draft? <i class="feather icon-chevrons-up sort-icon"></i></th>
                                                            <th class="sortable d-none d-xl-table-cell" data-column="11">Keterangan <i class="feather icon-chevrons-up sort-icon"></i></th>
                                            ...
                                            <div class="d-flex flex-wrap justify-content-between align-items-center px-1 py-2 border-top" style="gap:8px">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <select class="form-control form-control-sm" id="entriesSelect" style="width:72px">
...
function renderTable() {
    ...
    slice.forEach((pj, idx) => {
        ...
        let draftBadge = '';
        if      (pj.is_draft === 'yes') draftBadge = `<span class="badge text-white" style="background:#00499b">Ya</span>`;
        ...
        <tr class="main-row" data-id="${pj.id}" data-date="${pj.tanggal}" style="${rowBg}cursor:pointer">
            ...
            <td class="d-none d-xl-table-cell">${pj.nomor_transaksi ?? '-'}</td>
...
function applyFilters() {
    ...
    filteredData = allData.filter(pj => {
        ...
        let dateMatch = true;
        if (dateFrom) dateMatch = pj.tanggal >= dateFrom;
        if (dateTo)   dateMatch = dateMatch && pj.tanggal <= dateTo;
...
function updateInfo() {
    ...
    el.innerHTML = `Showing <strong>${start}</strong> to <strong>${end}</strong> of <strong>${filteredData.length}</strong> entries`;
}
