...
<head>
    <meta charset="UTF-8">
    <title>Print Laporan Penjualan Web</title>
    <style>
    ...
    <table>
        ...
        <tbody>
            @forelse ($penjualan as $index => $item)
                @php
                    $scanWeb = $item->scan_out ? ucfirst($item->scan_out) : '-';
            ...
            @empty
                <tr>
                    <td colspan="10">Belum ada data penjualan web pada filter ini.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
