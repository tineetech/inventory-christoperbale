    ...
    <div class="layout-content">
        <div class="container-fluid flex-grow-1 container-p-y">
            ...
            <div class="card col-lg-12 mb-4">
                <h6 class="card-header">Tambah Brand Baru</h6>
                <div class="card-body">
                    <form action="{{ route('brand.store') }}" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="nama_brand" class="form-control @error('nama_brand') is-invalid @enderror"
                                    placeholder="Masukkan nama brand" value="{{ old('nama_brand') }}" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="status_brand" class="form-control @error('status_brand') is-invalid @enderror">
                                    <option value="aktif" {{ old('status_brand') === 'aktif' ? 'selected' : '' }}>Aktif</option>
                                    <option value="nonaktif" {{ old('status_brand') === 'nonaktif' ? 'selected' : '' }}>Nonaktif</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi_brand" class="form-control @error('deskripsi_brand') is-invalid @enderror"
                                rows="3" placeholder="Deskripsi brand (opsional)">{{ old('deskripsi_brand') }}</textarea>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="feather icon-save"></i> Simpan Brand
                            </button>
                        </div>
                    </form>
                </div>
